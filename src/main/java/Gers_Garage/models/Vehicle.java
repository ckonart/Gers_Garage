...
public class Vehicle {
    ...
    public Vehicle(Integer id_vehicles, String model, CarMaker brand, Color color, Integer year, TypeVehicles type, EngineSize engine_size, Fuel fuel, String licence_number, Integer mileage, String details, Client client) {
    ...
    public TypeVehicles getType() {
        return type;
    }

    public void setType(TypeVehicles type) {
        this.type = type;
    }
